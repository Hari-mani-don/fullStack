...
if (cart_list != null) {
	...
	cartProduct = pDao.getCarProduct(cart_list);
...
<body>
	...
	<div class="container">
		<div class="d-flex py-3 ">
			<h3>Total Price: $ ${(total>0)?total:0.0}</h3>
			<a href="#" class="mx-3 btn btn-primary">Check Out</a>
		</div>
						...
						<form class="form-inline" action="" method="post">
							...
							<div class="form-group d-flex justify-content-between">
								<a class="btn btn-sm btn-decre" href="quantity-inc-dec"><i
									...
									name="quantity" value="3" class="form-control  form-control-sm"
									readonly> <a class="btn btn-sm btn-incre" href="quantity-inc-dec"><i
